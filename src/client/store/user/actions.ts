...
import { REGISTER_REQUEST, SuccessAction, REGISTER_SUCCESS, REGISTER_FAILURE, FailureAction, UPDATE_USER_DETAIL, SetUserAction, SET_USER, ClearUserAction, CLEAR, SetUserDetailAction, SET_USER_DETAIL } from './types';
